...
<body>
    ...
    <div class="container d-flex align-items-center justify-content-between">
        ...
        <div class="logo">
        <h1><a href="{{ url('/') }}"><img src="{{ asset('welcome_assets/img/logo.png') }}" alt="logo"/></a></h1>
        ...
        <ul>
            ...
            <li><a class="nav-link scrollto " href="#service">Facility</a></li>
            {{-- <li><a class="nav-link scrollto" href="#testimonials">Team</a></li> --}}
            <li><a class="nav-link scrollto" href="#contact">Contact Us</a></li>
            <li>
                @if (Route::has('login'))
                    @auth
                        <a href="{{ url('/dashboard') }}" class="getstarted scrollto">Book Now</a>
                    @else
    ...
    <section id="contact" class="contact">
        ...
        <div class="row">
            ...
            <div class="info">
                ...
                <div>
                <a href="https://wa.me/17811114" target="_blank"><i class="ri-phone-line"></i></a>
                <p><a href="https://wa.me/17811114" target="_blank">whatapp(17811114)</a></p>
                </div>

                <div>
                  <a href="tel:http://+97517811114" target="_blank"><i class="bi-phone" href="tel:http://+97517811114"></i></a>
                  
                  <p><a href="tel:http://+97517811114" target="_blank">(17811114)</a></p>
                  </div>
            ...
            <div class="col-lg-5 col-md-12 column right" data-aos="fade-up" data-aos-delay="300">
              <form  action="https://formsubmit.co/12200064.gcit@rub.edu.bt"  method="POST" >
                ...
                <input type="hidden" name="_autoresponse" value="We have received your message, thank you">
